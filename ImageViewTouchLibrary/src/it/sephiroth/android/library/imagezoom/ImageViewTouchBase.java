		 ...
		 */else if (type == DisplayType.FIT_TO_WIDTH) {
			if (getWidth() != 0 && getHeight() != 0) {
				...
				if ((mImageOriginalWidth - getWidth()) * mImageOriginalWidth / getWidth() > (mImageOriginalHeight - getHeight()) * mImageOriginalHeight
					...
					return 1f / ((((float) mImageOriginalWidth) * (((float) getHeight()) / mImageOriginalHeight)) / getWidth());
				}
			} else {
				return 1f;
			}
			...
			if (getWidth() != 0 && getHeight() != 0) {
				...
				if ((mImageOriginalWidth - getWidth()) * mImageOriginalWidth / getWidth() < (mImageOriginalHeight - getHeight()) * mImageOriginalHeight
					...
					return 1f / ((((float) mImageOriginalHeight) * (((float) getWidth()) / mImageOriginalWidth)) / getHeight());
				}
			} else {
				return 1f;
			}
